    ...
    return (
        <nav className="navbar navbar-expand-lg bg-body-tertiary" id="MainNavbar">
            <div className="container-fluid">
                <Link className="navbar-brand" to="#">Sai Print ToolBox</Link>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li className="nav-item">
                            <Link className="nav-link" to="#">Controle Version</Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link" to="#">ToolBox</Link>
                        </li>
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><Link className="dropdown-item" to="#">Login/Logoff</Link></li>
                            </ul>
                        </li>
                    </ul>
                </div>
